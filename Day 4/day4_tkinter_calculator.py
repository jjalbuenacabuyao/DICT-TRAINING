...
button_plus = Button(
    ...
    width=6,
    height=3,
    command=lambda: operator_select("+"),
)
...
button0 = Button(
    ...
    width=6,
    height=3,
    command=lambda: num_display("0"),
)
button0.grid(row=4, column=1, padx=2, pady=10)

button_equals = Button(
    root, text="=", font="SegoeUI 14", width=6, height=3, command=lambda: calculate()
)
